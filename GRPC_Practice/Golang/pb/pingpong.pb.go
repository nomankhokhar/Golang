...
// The only message we send back and forth
type Message struct {
...
const file_pingpong_proto_rawDesc = "" +
	"\n" +
	"\x0epingpong.proto\x12\bpingpong\"\x1d\n" +
	"\aMessage\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text2G\n" +
	"\vGameService\x128\n" +
	"\fPlayPingPong\x12\x11.pingpong.Message\x1a\x11.pingpong.Message(\x010\x01B\tZ\a./pb;pbb\x06proto3"
...
var file_pingpong_proto_depIdxs = []int32{
	0, // 0: pingpong.GameService.PlayPingPong:input_type -> pingpong.Message
	0, // 1: pingpong.GameService.PlayPingPong:output_type -> pingpong.Message
